...
time dot -Gdpi=1800 -Tpng -o $VisualsDirectory/LensorOS.dot.png $VisualsDirectory/LensorOS.dot

echo "    Generating undirected graph as 'LensorOS.sfdp.png' (this may take a while)"
time sfdp -Gdpi=1800 -Tpng -o $VisualsDirectory/LensorOS.sfdp.png $VisualsDirectory/LensorOS.dot
