...
Devices::AHCIPort::AHCIPort(
    ...
    AHCI::PortType type,
    uint8_t i,
    AHCI::HBAPort* port) : SystemDevice(SYSDEV_MAJOR_STORAGE, SYSDEV_MINOR_AHCI_PORT)
...
Devices::HDADevice::HDADevice(PCI::PCIHeader0* header)
    : SystemDevice(SYSDEV_MAJOR_MULTIMEDIA, SYSDEV_MINOR_HDA)
    , Header(header) {}
