...
mcopy_file(${REPO_DIR}/user/blazeit/blazeit /bin)
mcopy_file(${REPO_DIR}/user/stdout/stdout /bin)
mcopy_file(${REPO_DIR}/user/pwd/pwd /bin)
# TODO get rid of following lines once directory traversal works in FAT driver...
mcopy_file(${IMAGE_DIR}/dfltfont.psf "")
mcopy_file(${REPO_DIR}/user/stdout/stdout "")
mcopy_file(${REPO_DIR}/user/blazeit/blazeit "")
mcopy_file(${REPO_DIR}/user/pwd/pwd "")
